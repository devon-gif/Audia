...
export async function POST(req: Request) {
  ...
  return NextResponse.json({ brief: response.choices[0].message.content, summary: response.choices[0].message.content, summary: response.choices[0].message.content });
}
